"""
Django settings for gan project.
...
SECRET_KEY = 'su(7pi^zefepv0trql_hg#ti!drk2xa#915g$^can(qkjn7xxs'
...
EMAIL_PORT=587
EMAIL_USE_TLS=True
EMAIL_HOST_USER='balagandevelopers@gmail.com'
EMAIL_HOST_PASSWORD='BLG123456'
